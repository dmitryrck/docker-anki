...
add https://apps.ankiweb.net/downloads/current/anki-$ANKI_VERSION-linux-amd64.tar.bz2 /
...
run sed -i "/deb-src/d" /etc/apt/sources.list && \
  ...
  tar xfj /anki-$ANKI_VERSION-linux-amd64.tar.bz2 && cd /anki-$ANKI_VERSION-linux-amd64 && make install && \
  ...
  rm /anki-$ANKI_VERSION-linux-amd64.tar.bz2 && \
